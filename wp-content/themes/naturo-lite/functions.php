...
//	wp_enqueue_style( 'naturo_lite-animation-style', get_template_directory_uri().'/css/animation.css' );
	...
	// Added scripts
	wp_enqueue_script('naturo_lite-nivo-modernizr', get_template_directory_uri().'/js/modernizr.js');
	wp_enqueue_script('naturo_lite-nivo-pace', get_template_directory_uri().'/js/pace.min.js' );
	wp_enqueue_script('naturo_lite-nivo-plugins', get_template_directory_uri().'/js/plugins.js' , array(), '', true);
	wp_enqueue_script('naturo_lite-nivo-main', get_template_directory_uri().'/js/main.js' , array(), '', true);
	


	// Added styles
	wp_enqueue_style( 'naturo_lite-animation-style-base', get_template_directory_uri().'/css/base.css' );
	// wp_enqueue_style('naturo_lite-animation-style-colordark', get_template_directory_uri().'/css/colors-dark.css');
	// wp_enqueue_style('naturo_lite-animation-style-editorstyle', get_template_directory_uri().'/css/editor-style.css');
	// wp_enqueue_style('naturo_lite-animation-style-fonts', get_template_directory_uri().'/css/fonts.css');
	// wp_enqueue_style('naturo_lite-animation-style-ie8', get_template_directory_uri().'/css/ie8.css');	
	// wp_enqueue_style('naturo_lite-animation-style-ie9', get_template_directory_uri().'/css/ie9.css');
	wp_enqueue_style( 'naturo_lite-animation-style-vendor', get_template_directory_uri().'/css/vendor.css' );
	wp_enqueue_style( 'naturo_lite-animation-style-main', get_template_directory_uri().'/css/main.css');



	wp_enqueue_style( 'naturo_lite-animation-style-font-awesome', get_template_directory_uri().'/css/font-awesome/css/font-awesome.css' );
	wp_enqueue_style( 'naturo_lite-animation-style-font-awesome-min', get_template_directory_uri().'/css/font-awesome/css/font-awesome.min.css' );
